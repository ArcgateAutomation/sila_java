...
//Business User Registration
			...
			BusinessUser user = new BusinessUser(businessHandle, BusinessAddressAlias, streetAddress1, streetAddress2,
			         city, state, postalCode, phone, email, identityValue, 
			          Utility.getBusinessCryptoAddress(), crypto_alias, type, businessEntityName, businessType, business_website, 
			          doingBusiness_As, Utility.getDefaultNaicCategoryDescription(), country);
...
//link_business_member_administrator			
			ApiResponse businessRolesResponse = api.getBusinessRoles();
			...
			//BusinessRole business_role1= ((GetBusinessRolesResponse)businessRolesResponse.getData()).getBusinessRoles().get(1);
			
            ApiResponse LinkMemberResponseAsAdministrator = api.linkBusinessMember(handle22,
            ...
            System.out.println(LinkMemberResponseAsAdministrator.getStatusCode()); // 200
            System.out.println(((LinkBusinessMemberResponse)LinkMemberResponseAsAdministrator.getData()).getRole());


            
//link_business_member__ControlOfficer					
            ApiResponse LinkMemberResponseAsControlOffices = api.linkBusinessMember(handle22,
            		reader.getCellData(sheetName, privatekeys, 2), businessHandle,
            		reader.getCellData(sheetName, privatekeys, 41),
            		business_role_ControlOfficer, null, "test details", null);
			
            System.out.println(LinkMemberResponseAsControlOffices.getStatusCode()); // 200
            System.out.println(((LinkBusinessMemberResponse)LinkMemberResponseAsControlOffices.getData()).getDetails());
            System.out.println(((LinkBusinessMemberResponse)LinkMemberResponseAsControlOffices.getData()).getRole());
            System.out.println(((LinkBusinessMemberResponse)LinkMemberResponseAsControlOffices.getData()).getVerificationUuid());
...
//link_business_member__beneficial_owner			
          ...
          BusinessRole business_role_beneficial_owner= ((GetBusinessRolesResponse)businessRolesResponse.getData()).getBusinessRoles().get(1);
            ApiResponse LinkMemberResponseAsbeneficial_owner = api.linkBusinessMember(handle23,
...
//Get Entity
        ...
        // Success Object Response
           System.out.println(getEntityResponse.getStatusCode()); // 200
           //System.out.println("getAddresses: "+((GetEntityResponse)getEntityResponse.getData()).getAddresses());
           System.out.println("getEntityType: "+((GetEntityResponse)getEntityResponse.getData()).getEntityType());
           System.out.println("getEntity: "+((GetEntityResponse)getEntityResponse.getData()).getEntity());
           //System.out.println("getIdentities: "+((GetEntityResponse)getEntityResponse.getData()).getIdentities());
           //System.out.println("getMembers: "+((GetEntityResponse)getEntityResponse.getData()).getMembers());
           String membership_token= ((GetEntityResponse) getEntityResponse.getData()).getMemberships().get(0).toString();
//           System.out.println("getMemberships data1: "+((GetEntityResponse)getEntityResponse.getData()).getMemberships().get(0));
//           System.out.println("getMemberships data2: "+((GetEntityResponse)getEntityResponse.getData()).getMemberships().get(1));
//           System.out.println("getMemberships data3: "+((GetEntityResponse)getEntityResponse.getData()).getMemberships().get(2));
//           System.out.println("getMemberships data4: "+((GetEntityResponse)getEntityResponse.getData()).getMemberships().get(3));
//           System.out.println("getMemberships data5: "+((GetEntityResponse)getEntityResponse.getData()).getMemberships().get(4));
           //System.out.println("getPhones: "+((GetEntityResponse)getEntityResponse.getData()).getPhones());
          // System.out.println("getEmails: "+((GetEntityResponse)getEntityResponse.getData()).getEmails());
