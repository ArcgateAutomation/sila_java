...
public class Test13_Register_update_registration_data extends Base_class {
	...
	UserHandleMessage user1 = UserHandleMessage.builder().userHandle(handle27).userPrivateKey(reader.getCellData(sheetName, privatekeys, 7)).build();
	AddressMessage AddDEtailsMessage = AddressMessage.builder().addressAlias(addAddressAlias).streetAddress1(addStreetAddress1).streetAddress2(addStreetAddress2).city(addCity).state(addState).country(addCountry).postalCode("9722543881").build();
	 api.addAddress(user1, AddDEtailsMessage);
...
///////////////////////////////////////////////
   ...
   @Test(priority = 60)
    ...
    public void test_060_registration_update_birth_date_as_18_years() throws Exception {
		...
		System.out.println(yearbefore18);
